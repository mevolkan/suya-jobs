                    ...
                    <div class="details">
                        <div>
                            <p><strong>Location:</strong>
                                <?php echo esc_html(get_post_meta(get_the_ID(), 'location', true)); ?></p>
                        </div>
                        <div>
                            <p><strong>Close Date:</strong>
                                <?php echo esc_html(get_post_meta(get_the_ID(), 'close_date', true)); ?></p>
                        </div>
                        <div>
                            <a class="nectar-button large regular accent-color  regular-button" role="button"
                                href="<?php echo esc_html(wp_get_attachment_url(get_post_meta(get_the_ID(), 'download', true))); ?>">
                                Download </a></p>
                        </div>
                    </div>
